...
def int_check():
    """Checks users enter anm integer more than / repeat to 13"""
...
#At the start of the game, computer / User
comp_score = 0
user_score = 0
rounds_played = 0
...
while comp_score < game_goal and user_score < game_goal:
    ...
    # if the user and computer roll equal points, the users is player 1...
        ...
        print("The initial rolls were the same, the user ")


    # if the computer has fewer points, switch the computer to 'player1'
    else:
    ...
    # Generate round results and add it to rhw game history list
    ...
    print("*** Game Update ***")         # replace with call to statement purpose
